jQuery("#simulation")
  .on("click", ".s-f262ade5-7a7a-47a2-8f7e-bb86db3e8e5f .click", function(event, data) {
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/495ce63a-d8fb-4a1a-b275-842a3eab0006"
                  },
                  "exectype": "serial",
                  "delay": 0
                }
  ...
  .on("focusin", ".s-f262ade5-7a7a-47a2-8f7e-bb86db3e8e5f .focusin", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "#s-f262ade5-7a7a-47a2-8f7e-bb86db3e8e5f #s-Input_2 input": {
                      "attributes": {
                        "color": "#FFFFFF"
                      }
                    }
                  },{
                    "#s-f262ade5-7a7a-47a2-8f7e-bb86db3e8e5f #s-Input_2 > .backgroundLayer": {
                      "attributes": {
                    ...
                    "#s-f262ade5-7a7a-47a2-8f7e-bb86db3e8e5f #s-Input_2": {
                      "attributes-ie": {
                ...
                },
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-f262ade5-7a7a-47a2-8f7e-bb86db3e8e5f #s-Button_1 > .backgroundLayer": {
                      "attributes": {
                        "background-color": "transparent",
                    ...
                    "#s-f262ade5-7a7a-47a2-8f7e-bb86db3e8e5f #s-Button_1": {
                      "attributes-ie": {
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-f262ade5-7a7a-47a2-8f7e-bb86db3e8e5f #s-Input_3 input": {
                      "attributes": {
                        "color": "#FFFFFF"
                      }
                    }
                  },{
                    "#s-f262ade5-7a7a-47a2-8f7e-bb86db3e8e5f #s-Input_3 > .backgroundLayer": {
                      "attributes": {
                        "background-color": "transparent",
                        "background-image#moz": "-moz-linear-gradient(top,#0087CB,#006CA3)",
                        "background-image#wk": "-webkit-linear-gradient(top,#0087CB,#006CA3)",
                    ...
                    "#s-f262ade5-7a7a-47a2-8f7e-bb86db3e8e5f #s-Input_3": {
                      "attributes-ie": {
                        "-pie-background": "linear-gradient(to bottom,#0087CB,#006CA3)",
                        "-pie-poll": "false"
                      }
  ...
  .on("focusout", ".s-f262ade5-7a7a-47a2-8f7e-bb86db3e8e5f .focusout", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("mouseenter dragenter", ".s-f262ade5-7a7a-47a2-8f7e-bb86db3e8e5f .mouseenter", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("mouseleave dragleave", ".s-f262ade5-7a7a-47a2-8f7e-bb86db3e8e5f .mouseleave", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getDirectEventFirer(this);
